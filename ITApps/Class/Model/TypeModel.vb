...
Public Class TypeModel
    ...
    Public Function save(obj As Object, mye As ContentBaseEventArgs) As Boolean Implements IModel.save
        ...
        Using conn As Object = myadapter.getConnection
            ...
            dataadapter.UpdateCommand.Parameters.Add("", NpgsqlTypes.NpgsqlDbType.Varchar, 0, "typename").SourceVersion = DataRowVersion.Current
