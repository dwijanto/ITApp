...
Public Class ManufactureModel
    ...
    Public Function save(obj As Object, mye As ContentBaseEventArgs) As Boolean Implements IModel.save
        ...
        Using conn As Object = myadapter.getConnection
            ...
            sqlstr = "it.sp_deletemanufacture"
            ...
            sqlstr = "it.sp_updatemanufacture"
            ...
            dataadapter.UpdateCommand.Parameters.Add("", NpgsqlTypes.NpgsqlDbType.Varchar, 0, "manufacturename").SourceVersion = DataRowVersion.Current
